...
$taskName = "AD-user-generate-table-report-mailbox-hidden"
$taskGetAdUsersGuid = ""
...
$dataSourceName = "AD-user-generate-table-report-mailbox-hidden"
...
$formName = "AD - Report - Accounts where the mailbox is hidden"
$formGuid = ""
...
try
{
        ...
        [
  {
    ...
    "body": "The following report will show local AD accounts where the Exchange Mailbox is hidden. Please wait while the data is loading...",
...
$delegatedFormName = "AD - Report - Accounts where the mailbox is hidden"
$delegatedFormGuid = ""
...
$taskActionName = "AD-export-report-accounts-mailbox-hidden"
$taskActionGuid = ""
